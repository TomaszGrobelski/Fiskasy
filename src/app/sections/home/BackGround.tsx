...
const BackGround = () => {
  return (
    <>
      ...
      <p className='absolute left-[194px] top-[1265px] h-[24px] w-[11px] text-[20px] font-extrabold leading-[51px] opacity-[0.22] md:top-[2075px] md:left-[1748px] md:text-[75px]'>2</p>
      ...
      <p className='absolute left-[15px] top-[1447px] h-[51px] w-[21px] text-[42px] font-extrabold leading-[51px] opacity-[0.22]'>-</p>
      ...
      {/* Dased + + */}
      <p className='absolute left-[394px] top-[2125px] h-[51px] w-[24px] text-[42px] font-extrabold leading-[51px] opacity-[0.22]'>+</p>
      ...
      <p className='tetx-left absolute left-[312px] top-[3566px] h-[51px] w-[24px] text-[42px] font-extrabold leading-[51px] opacity-[0.22] md:left-[1660px] md:top-[679px] md:text-[75px]'>
        9
      </p>

      <svg width={171} height={171} className='absolute left-[116px] top-[3668px] h-[171px] w-[171px]'>
        <circle cx='85.5' cy='85.5' r='83' stroke='black' strokeWidth='1' fill='none' strokeDasharray='3 3' />
      </svg>
      <BlueCircle className='left-[180px] top-[3720px] -z-10 h-[131px] w-[132px] bg-left-top bg-no-repeat md:hidden' />
      <p className='absolute left-[394px] top-[3797px] h-[51px] w-[21px] scale-x-150 text-[42px] font-extrabold leading-[51px] opacity-[0.22] md:top-[1248px] md:left-[1662px] md:scale-[170%]'>-</p>
      ...
      <div className='customBgElement -z-20'></div>
