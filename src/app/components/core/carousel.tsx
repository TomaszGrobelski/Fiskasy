...
function CarouselNavigation({ className, classNameButton, alwaysShow }: CarouselNavigationProps) {
  ...
  return (
    ...
    >
      ...
      >
        <Image src='/icons/promotions/alo.png' width={70} height={70} alt='Left arrow' />
      </button>
      <button
        type='button'
        className={cn(
      ...
      >
        <Image src='/icons/promotions/alj.png' width={70} height={70} alt='Right arrow' />
      </button>
    </div>
  );
}
{
  /* <Image src='/icons/promotions/alo.png' width={70} height={70} alt='' /> */
}
