...
const Footer = () => {
  return (
    <div className='relative mt-10 h-[530px] overflow-y-clip'>
      ...
      >
        ...
        />
        <Image
          src='/images/footer/alt.png'
          width={283}
          height={30}
          alt='Posnet baner'
          className='h-[35px] w-[200px] object-contain'
        />
        <Image
          src='/images/footer/alr.png'
          width={345}
          height={30}
          alt='Datecs baner'
          className='h-[35px] w-[200px] object-contain'
      ...
      <div className='top-56 flex w-full items-center justify-center gap-10 sm:relative sm:top-40 md:gap-14 xl:gap-20 2xl:gap-24'>
        <Image
          src='/images/footer/ajv.png'
          width={57}
          height={59}
          alt='ESC logo'
          className='absolute left-[190px] top-[250px] z-30 h-[59px] w-[57px] object-contain sm:static 2xl:h-[103px] 2xl:w-[100px]'
        />
        ...
        <Image
          src='/images/footer/aji.png'
          width={172}
          height={73}
          alt='Fiskasy logo'
          className='hidden md:block 2xl:h-[73px] 2xl:w-[172px]'
        />
      </div>
      ...
      <svg
        width={492}
        height={492}
        className='absolute bottom-[70px] left-[140px] -z-10 h-[492px] w-[492px] -translate-x-1/2 translate-y-1/2 transform lg:left-[80px]'
      >
      ...
      <svg
        width={640}
        height={640}
        className='absolute hidden xl:block bottom-[70px] right-[-300px] z-10 h-[640px] w-[640px] translate-x-1/2 translate-y-1/2 transform '
      >
