...
const ProductCard = ({ title, image, price, isOnlline }: IProductCard) => {
  return (
    <div className='relative flex h-[175px] w-[129px] flex-col items-center rounded-[7px] bg-white shadow-discountBoxShadow md:h-[331px] md:w-[240px] md:rounded-[35px]'>
      <p className='mx-auto mt-[21px] h-[11px] w-[74px] text-center text-[9px] font-extrabold md:w-[200px] md:h-[46px] md:text-[20px]'>{title}</p>
